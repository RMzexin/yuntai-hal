...
unsigned char MPU_WaitForReady(unsigned char devaddr);
unsigned char MPU_Write_Byte(unsigned char devaddr,unsigned char reg,unsigned char data);
unsigned char MPU_Read_Byte(unsigned char devaddr,unsigned char reg);
